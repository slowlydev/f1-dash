		...
		>
			...
			<div>
				...
				<div className="flex items-center gap-1">
					<LazyData
						data={weather?.wind_direction !== undefined ? getWindDirection(weather.wind_direction) : undefined}
					/>
...
function LazyData({ data, unit }: { data: string | number | undefined; unit?: string }) {
	return (
		<>
			{data !== undefined ? (
				...
				<dd className="h-8 animate-pulse rounded-md bg-gray-700 font-semibold" style={{ width: "70%" }}></dd>
			)}
		</>
	);
}
